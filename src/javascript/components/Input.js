    ...
    <div className={"inputContainer " + margin}>
      {type === "text-area" ? (
        <svg
          width="1837"
          height="1659"
          viewBox="0 0 1837 1659"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className={focused ? "hexDecorationTA" : "hexDecorationTA hidden"}
        >
          <g id="HexagonInputDecorationForTA">
            <g id="HexBottoms" className="translateY-neg-8-5">
              <g
                id="RemainderBottom"
              ...
              >
                <path
                  id="Polygon 50"
                  d="M1663.79 1445.64L1741.5 1400.77L1819.21 1445.64V1535.36L1741.5 1580.23L1663.79 1535.36V1445.64Z"
                  stroke="url(#paint0_linear_715_7)"
                  strokeWidth="10"
                />
                <line
                  id="Line 93"
                  ...
                  x2="1801.5"
                  y2="1519.5"
                  stroke="url(#paint1_linear_715_7)"
                  strokeWidth="5"
                  strokeLinecap="round"
                />
                <line
                  ...
                  x2="1683.5"
                  y2="1519.5"
                  stroke="url(#paint2_linear_715_7)"
                  strokeWidth="5"
                  strokeLinecap="round"
                />
              </g>
              <g id="HexMiddleBottom" className={focused ? "hexAnimate" : ""}>
                <path
                  id="Polygon 49"
                  d="M1582.79 1311.64L1660.5 1266.77L1738.21 1311.64V1401.36L1660.5 1446.23L1582.79 1401.36V1311.64Z"
                  stroke="#112849"
                  strokeWidth="10"
                />
                <line
            ...
            <g id="TopHexs">
              ...
              >
                <path
                  ...
                  stroke="url(#paint3_linear_715_7)"
                  strokeWidth="10"
                />
                <line
                  id="Line 95"
                  ...
                  x2="117.415"
                  y2="131.915"
                  stroke="url(#paint4_linear_715_7)"
                  strokeWidth="5"
                  strokeLinecap="round"
                />
                <line
                  ...
                  x2="115.915"
                  y2="204.415"
                  stroke="url(#paint5_linear_715_7)"
                  strokeWidth="5"
                  strokeLinecap="round"
                />
                <line
                  ...
                  x2="234.5"
                  y2="139.5"
                  stroke="url(#paint6_linear_715_7)"
                  strokeWidth="5"
                  strokeLinecap="round"
                />
              </g>
              ...
              <g
                id="RemainderTop"
                className={
                  focused ? "hexAnimate animation-delay-3-quarters" : ""
                }
              >
                <line
                  id="Line 89"
      ...
      {type !== "select" ? (
        type !== "text-area" ? (
          ...
          <textarea
            rows={height}
            placeholder={placeholder}
            className={"customInputTA " + width + " padding-top-1"}
            onFocus={() => setFocused(true)}
            onBlur={() => setFocused(false)}
          ></textarea>
        )
